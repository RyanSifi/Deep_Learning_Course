...
class MultiHeadAttention(nn.Module):
    ...
    Args:
        d_model (int): The dimension of the model. This is the size of the input and output vectors for each layer in the model.
...
class DecoderLayer(nn.Module):
    """
    Decoder Layer consisting of Masked Multi-Head Attention, Multi-Head Attention, and Position-wise Feed-Forward Network.
...
class Transformer(nn.Module):
    """
    Transformer model consisting of Encoder and Decoder layers.
